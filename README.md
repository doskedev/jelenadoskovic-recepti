...
- Sajt: https://jelenadoskovic.com/
- Svaki recept ima zasebnu stranicu: `https://jelenadoskovic.com/recept/<naziv-recepta>/`
- `recepti.md` – svi recepti kao tekst
- `recepti.json` – strukturirani podaci (naslov, slug, datum, sastojci, postupak, link na post)
- `sitemap.xml` – spisak svih 553 adresa
